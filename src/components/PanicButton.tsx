      ...
      <AnimatePresence>
        {panicCountdown !== null && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-slate-950/98 backdrop-blur-xl z-[9999] flex flex-col items-center justify-center p-6 text-center select-none overflow-y-auto"
            style={{ touchAction: "manipulation" }}
          >
            {/* High-tech tactical background overlay */}
            <div className="absolute inset-0 digital-grid opacity-25 pointer-events-none" />
            <div className="absolute top-4 left-4 right-4 flex justify-between items-center font-mono text-[8px] text-slate-500 uppercase">
              <span>TACTICAL MESH GATEWAY SECURE-LINK-V4</span>
              <span className="text-red-500 font-bold animate-pulse flex items-center gap-1.5">
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                PRE-PANIC COCKPIT ACTIVE
              </span>
            </div>

            <div className="space-y-6 max-w-sm w-full relative z-10 my-auto">
              <div className="flex flex-col items-center space-y-1">
                <span className="text-[10px] font-mono font-black text-red-500 uppercase tracking-[0.3em] animate-pulse">
                  ⚠️ PENDING DISTRESS ESCALATION ⚠️
                </span>
                <p className="text-[10px] text-slate-400 font-mono">
                  Broadcasting default global SOS beacon in {panicCountdown}s...
                </p>
              </div>
              ...
              <div className="relative w-48 h-48 mx-auto flex items-center justify-center">
                ...
                >
                  <span className="text-5xl font-black font-display leading-none tracking-tight">
                    {panicCountdown}
                  </span>
              ...
              {/* High-Tech Presets Drawer for Effective Alert Channels */}
              <div className="space-y-3 pt-2">
                <div className="text-left">
                  <span className="text-[8px] font-mono font-black text-slate-500 uppercase tracking-widest block mb-2 text-center">
                ...
                <div className="grid grid-cols-1 gap-2 text-left">
                  ...
                  <button
                    ...
                    onClick={() => {
                      cancelSOS();
                      useAppStore.getState().addAuditLog('DISPATCH', 'SEVERE', 'Preset Triggered: Hijack / Car Accident', 'Immediate route to Mom and Thabo initiated.');
                      useAppStore.getState().triggerPanic("Car Accident / Hijacked: Emergency routing to Mom (+27829110000) & Thabo (+27721234567)");
                    }}
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] font-mono text-slate-500">
                        Route: Mom & Thabo Molefe (#userpreferences)
                      </div>
                    </div>
                    <span className="text-[9px] font-mono text-slate-600 group-hover:text-red-400 font-bold">DISPATCH &rarr;</span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      cancelSOS();
                      useAppStore.getState().addAuditLog('DISPATCH', 'SEVERE', 'Preset Triggered: Clock-In Time Check-In', 'Routing to Supervisor and Control Room.');
                      useAppStore.getState().triggerPanic("Clock-In Time Check-In: Notifying Control Room supervisor (+27600123456)");
                    }}
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] font-mono text-slate-500">
                        Route: Notify Control Room supervisor
                      </div>
                    </div>
                    <span className="text-[9px] font-mono text-slate-600 group-hover:text-blue-400 font-bold">NOTIFY &rarr;</span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      cancelSOS();
                      useAppStore.getState().addAuditLog('DISPATCH', 'SEVERE', 'Preset Triggered: Security Room Emergency', 'Routing alert to pre-saved tactical control room.');
                      useAppStore.getState().triggerPanic("Security Room Distress: Alerting presaved Control Room guard station (+27650987654)");
                    }}
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] font-mono text-slate-500">
                        Route: Presaved tactical guard console
                      </div>
                    </div>
                    <span className="text-[9px] font-mono text-slate-600 group-hover:text-cyan-400 font-bold">ALERT &rarr;</span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      cancelSOS();
                      useAppStore.getState().addAuditLog('DISPATCH', 'SEVERE', 'Preset Triggered: Medical Emergency', 'Routing to private ambulance dispatch.');
                      useAppStore.getState().triggerPanic("Medical Emergency / Trauma: Notifying family and Private Ambulance Unit (+27839119112)");
                    }}
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] font-mono text-slate-500">
                        Route: Family & Private Ambulance Service
                      </div>
                    </div>
                    <span className="text-[9px] font-mono text-slate-600 group-hover:text-emerald-400 font-bold">MEDICAL &rarr;</span>
                  </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      cancelSOS();
                      useAppStore.getState().addAuditLog('DISPATCH', 'SEVERE', 'Preset Triggered: Suspicious Escort', 'Routing alert to Community Watch.');
                      useAppStore.getState().triggerPanic("Suspicious Escort Request: Notifying Community Watch Patrol Escort (+27829110000)");
                    }}
                  ...
                  >
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] font-mono text-slate-500">
                        Route: Neighborhood Watch dispatch escorts
                      </div>
                    </div>
                    <span className="text-[9px] font-mono text-slate-600 group-hover:text-amber-400 font-bold">ESCORT &rarr;</span>
                  </button>
                </div>
              </div>
            </div>
