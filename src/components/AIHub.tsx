...
export const AIHub: React.FC = () => {
  ...
  const handleChatSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      } else if (promptLower.includes('who are you') || promptLower.includes('kleva') || promptLower.includes('k\'leva')) {
        reply = `IDENT DECRYPT: I am K'leva.info, your edge-computing AI safety agent. Built specifically for high-durability Mesh Networks to coordinate medical, tactical, and community nodes.`;
      } else {
