      ...
      >
        ...
        >
          <svg 
            ...
            className="w-full h-full drop-shadow-[0_6px_16px_rgba(0,0,0,0.85)]"
          >
            <defs>
              {/* Premium Metallic Bevel Steel Gradient for the Shield */}
              <linearGradient id="logoSteelShield" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#1e293b" />
                <stop offset="15%" stopColor="#475569" />
                <stop offset="35%" stopColor="#8f9fae" />
              ...
              {/* Glowing Vibrant Neon Green Gradient for the Chain Link & Arrow */}
              <linearGradient id="logoNeonGreen" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              {/* Premium Chrome-Steel Gradient for Logo Typography */}
              <linearGradient id="logoChromeText" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              {/* Elegant Green Glow Filter */}
              <filter id="neonChainGlow" x="-30%" y="-30%" width="160%" height="160%">
                <feDropShadow dx="0" dy="0" stdDeviation="8" floodColor="#10b981" floodOpacity="0.85" />
                <feDropShadow dx="0" dy="0" stdDeviation="2" floodColor="#34d399" floodOpacity="0.95" />
              </filter>

              {/* 3D Specular Chrome Reflection Filter */}
              <filter id="bevelSpecularRef">
                <feGaussianBlur in="SourceAlpha" stdDeviation="1.5" result="blur" />
                <feSpecularLighting in="blur" surfaceScale="5" specularConstant="1.2" specularExponent="22" lightingColor="#fff" result="spec">
            ...
            <g transform="translate(0,327) scale(0.100000,-0.100000)" stroke="none">
              ...
              <g fill="url(#logoSteelShield)" filter="url(#bevelSpecularRef)">
                ...
                {/* Central Emblem Core */}
                <path d="M2750 1824 c-320 -302 -323 -304 -379 -304 -120 0 -175 141 -88 227 l35 35 -28 62 c-15 33 -31 72 -36 84 -9 23 -11 23 -72 -33 -86 -79 -117 -145 -116 -245 1 -91 28 -154 92 -218 61 -62 120 -86 212 -86 59 -1 85 4 121 22 28 14 155 123 324 279 l278 257 -59 13 c-32 8 -73 22 -92 33 -18 11 -34 20 -35 20 -1 0 -72 -66 -157 -146z m220 85 c30 -11 56 -22 58 -24 4 -3 2 -5 -128 -125 -56 -52 -121 -113 -144 -135 -122 -117 -233 -212 -269 -231 -61 -32 -161 -32 -229 -1 -56 26 -115 83 -144 139 -27 53 -30 153 -5 218 23 61 114 162 130 145 4 -6 16 -31 25 -56 l18 -46 -31 -44 c-29 -41 -36 -70 -32 -136 1 -26 67 -103 87 -103 8 0 14 -4 14 -8 0 -18 72 -12 114 10 37 19 193 158 336 298 53 52 132 120 139 120 3 0 31 -9 61 -21z" />
              </g>

              {/* GROUP 1.5: Glowing Neon green Diagonal Chain Link & Arrow (Vivid Branding Highlight) */}
              <g fill="url(#logoNeonGreen)" filter="url(#neonChainGlow)">
                {/* Chain Loop Core */}
                ...
                {/* Arrow Diagonal Stem Link */}
                <path d="M2300 1700 l900 900 l-140 140 l-900 -900 l140 -140 z" />
              </g>

              {/* GROUP 2: Highly Polished Chrome Typography "SAFETY LINK" (Paths 6-16) */}
              {showText && (
                <g fill="url(#logoChromeText)" filter="url(#bevelSpecularRef)">
                  {/* S */}
                  ...
                  {/* A (Outer) */}
                  <path d="M772 918 c-16 -35 -77 -166 -136 -291 -58 -126 -106 -229 -106 -230 0 -1 34 0 76 3 l76 5 23 55 23 55 144 3 143 3 26 -60 27 -59 76 -4 c42 -2 76 0 76 3 0 4 -30 69 -66 145 -37 77 -97 204 -135 284 l-69 145 -75 3 -74 3 -29 -63z m182 -13 c12 -22 41 -83 65 -135 24 -52 64 -135 89 -185 24 -49 50 -105 57 -125 l13 -37 -40 -1 c-48 -2 -64 9 -73 47 -3 16 -17 39 -30 51 -23 21 -33 23 -154 22 -72 0 -140 -3 -151 -7 -13 -4 -31 -28 -46 -61 -24 -52 -26 -54 -65 -54 -36 0 -39 2 -36 23 6 34 83 188 90 180 4 -3 7 6 7 22 0 15 13 53 29 84 17 31 44 88 62 126 44 97 44 96 107 93 52 -3 55 -5 76 -43z" />
                  {/* A (Inner) */}
                  <path d="M848 838 c-8 -13 -32 -63 -53 -112 -49 -115 -46 -120 68 -124 83 -3 127 7 127 28 0 5 -14 40 -31 77 -17 37 -31 75 -32 84 -1 10 -5 15 -9 13 -4 -3 -8 1 -8 9 0 13 -30 47 -42 47 -3 0 -12 -10 -20 -22z m84 -127 c21 -46 38 -84 38 -85 0 -1 -43 -1 -95 -1 -52 0 -95 0 -95 1 0 0 17 41 38 90 21 49 42 98 46 109 8 19 9 19 19 -5 6 -14 28 -63 49 -109z" />
                  {/* F */}
                  ...
                  {/* E */}
                  <path d="M1857 690 l3 -291 235 -2 235 -2 0 58 0 57 -165 0 -165 0 0 65 0 65 145 0 145 0 0 56 0 55 -145 -3 -145 -3 0 63 0 63 160 -3 160 -3 0 58 0 57 -232 0 -233 0 2 -290z m440 232 l-4 -27 -143 -3 c-87 -1 -148 -6 -157 -13 -7 -6 -13 -23 -13 -38 0 -15 -6 -33 -12 -40 -11 -11 -10 -12 1 -6 11 6 13 2 9 -19 -9 -45 21 -56 158 -59 l119 -2 0 -25 0 -25 -122 0 c-151 -1 -157 -4 -154 -97 1 -35 7 -68 14 -75 8 -8 61 -13 162 -15 146 -3 150 -4 153 -25 5 -32 -17 -35 -234 -31 l-189 3 -3 263 -2 263 210 -1 210 -1 -3 -27z" />
                  {/* T */}
                  <path d="M2390 919 l0 -61 100 4 101 3 -3 -232 -3 -232 73 -3 72 -3 0 235 0 235 100 -3 100 -4 0 61 0 61 -270 0 -270 0 0 -61z m510 7 c0 -30 -16 -36 -100 -36 -49 0 -71 -4 -80 -16 -10 -11 -14 -70 -14 -232 l-1 -217 -47 -3 -47 -3 0 222 c0 153 -4 225 -12 235 -8 10 -36 14 -95 14 l-84 0 0 30 0 30 240 0 240 0 0 -24z" />
                  {/* Y */}
                  <path d="M2950 976 c0 -3 52 -86 115 -185 l115 -180 0 -105 0 -104 75 -4 75 -3 0 105 0 106 115 182 c63 101 115 185 115 188 0 2 -33 4 -72 4 l-73 -1 -75 -124 c-41 -69 -77 -124 -80 -124 -3 0 -39 56 -80 124 l-75 124 -77 1 c-43 0 -78 -2 -78 -4z m141 -38 c15 -12 31 -36 118 -176 48 -75 59 -70 142 63 38 60 69 113 69 117 0 5 20 8 45 8 25 0 45 -2 45 -4 0 -4 -57 -99 -85 -141 -11 -17 -25 -39 -32 -50 -7 -11 -29 -47 -49 -80 -35 -56 -37 -65 -39 -150 -1 -49 -3 -93 -3 -97 -1 -4 -22 -7 -47 -6 l-45 2 0 91 0 91 -105 167 c-58 92 -105 169 -105 172 0 11 77 4 91 -7z" />
                  {/* L */}
                  <path d="M3880 688 l0 -293 225 0 225 0 0 58 0 57 -152 0 -153 0 3 235 3 235 -76 0 -75 0 0 -292z m117 43 c1 -182 4 -216 17 -230 13 -13 41 -16 154 -16 l137 -1 0 -29 0 -30 -193 -1 c-105 -1 -194 1 -196 5 -5 8 -9 203 -7 389 l1 133 43 -3 42 -3 2 -214z" />
                  {/* I */}
                  <path d="M4420 688 l0 -293 75 3 75 4 0 289 0 289 -75 0 -75 0 0 -292z m119 5 c0 -186 -4 -260 -12 -265 -7 -4 -26 -8 -43 -8 -25 0 -33 5 -36 23 -4 19 -3 410 1 485 1 19 6 22 46 22 l44 0 0 -257z" />
                  {/* N */}
              ...
              {showText && (
                <g fill="url(#logoChromeText)">
                  ...
                  <path d="M4099 196 c-8 -13 3 -196 12 -196 5 0 9 40 9 90 0 50 0 93 1 97 1 9 -15 15 -22 9z" />
