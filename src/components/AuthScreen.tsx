    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-900/60 rounded-3xl p-6.5 shadow-2xl relative z-10 overflow-hidden">
        ...
        <div className="text-center mb-6 mt-1">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-br from-red-500 to-orange-500 text-white shadow-lg shadow-red-900/30 mb-3">
          ...
          <h1 className="text-xl font-black tracking-tight text-slate-100 uppercase font-mono">
            SafetyLink <span className="text-xs bg-red-500/10 text-red-400 border border-red-500/20 px-1.5 py-0.5 rounded ml-1 lowercase">v2.0</span>
          </h1>
          <p className="text-xs text-slate-400 mt-1">Sequential Emergency Alert Network</p>
        </div>
