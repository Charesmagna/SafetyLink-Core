...
export const CommerceCenter: React.FC = () => {
  ...
  const getCalculatorTotals = () => {
    ...
    const subtotal = licenseCost + subscriberSurcharge + guardLicenseSurcharge + beaconHardwareCost;
                          ...
                          {SUBSCRIPTION_PLANS.map(plan => (
                            ...
                            >
                              ...
                              <div>
                                ...
                                <span className="block text-xs font-mono font-extrabold text-blue-400 mt-1.5">R {plan.priceZAR} /mo</span>
                              </div>
                            </label>
                          ))}
                        </div>
