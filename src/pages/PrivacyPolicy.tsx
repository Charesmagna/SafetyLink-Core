...
const PrivacyPolicy: React.FC = () => (
  <div style={{ maxWidth: '800px', margin: '80px auto', padding: '0 24px', fontFamily: 'Inter, sans-serif', color: '#1e293b', lineHeight: 1.8 }}>
    ...
    <section style={{ marginBottom: '32px' }}>
      ...
      <p>SafetyLink is an emergency response platform operated by TM Media Solutions (Pty) Ltd, registration number 2018/500191/07, based in South Africa. Our platform is available at <a href="https://safetylink.online" style={{ color: '#15803d' }}>safetylink.online</a>. Contact us at <a href="mailto:info@safetylink.online" style={{ color: '#15803d' }}>info@safetylink.online</a> or WhatsApp +27 68 007 9911.</p>
    </section>
