import { createThingsBoardCustomer, deleteThingsBoardCustomer } from "./src/services/app_applet_safetylink-web_src_api_services_thingsboard.js";
...
// [RESTORED] ThingsBoard IoT Hooks


app.post("/api/iot/provision", async (req, res) => {
  try {
    const { orgName } = req.body;
    const tbClient = await createThingsBoardCustomer(orgName, process.env);
    res.json({ success: true, customerId: tbClient.id.id });
  } catch(e) {
