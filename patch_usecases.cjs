...
const useCasesCode = `import React, { useState } from 'react';
...
fs.writeFileSync('src/components/landing/UseCases.tsx', useCasesCode, 'utf8');
console.log("Patched UseCases.tsx");
