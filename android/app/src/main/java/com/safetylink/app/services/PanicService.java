...
public class PanicService extends Service {
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        // SafetyLink is "Recents Swipe Immune."
        // We override onTaskRemoved() and restart PanicService.java within 2 seconds.
        Intent restartIntent = new Intent(getApplicationContext(), PanicService.class);
