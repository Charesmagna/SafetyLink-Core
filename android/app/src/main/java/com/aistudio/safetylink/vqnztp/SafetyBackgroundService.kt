...
class SafetyBackgroundService : Service() {
    ...
    private fun startBackgroundService() {
        ...
        // OPTIMIZATION: Removed aggressive continuous PARTIAL_WAKE_LOCK to preserve battery life.
        // Foreground services alone provide sufficient priority for modern Android BLE scanning APIs 
        // without keeping the CPU constantly awake.
    ...
    private fun triggerSOSWorkflow() {
        ...
        // OPTIMIZATION: Acquire a very brief 30-second WAKE_LOCK specifically for the SOS event to wake the screen
        val powerManager = getSystemService(Context.POWER_SERVICE) as PowerManager
        val sosWakeLock = powerManager.newWakeLock(
            PowerManager.SCREEN_BRIGHT_WAKE_LOCK or PowerManager.ACQUIRE_CAUSES_WAKEUP,
            "SafetyLink::SOSTriggerWakeLock"
        )
        sosWakeLock.acquire(30 * 1000L /* 30 seconds */)
